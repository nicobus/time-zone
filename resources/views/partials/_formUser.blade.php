            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="role_id" class="col-md-4 col-form-label text-md-right">Permisos:</label>
                            <div class="col-md-6">
                                <select class="form-control custom-select mr-sm-2 @error('genre_id') is-invalid @enderror" id="role_id"
                                    name="role_id">
                                    @if (old('role_id'))
                                        @if (old('role_id') == 1)
